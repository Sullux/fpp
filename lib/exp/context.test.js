...
/* The context module supports tracking context and debug tracing across
  ...
  * context.defaultStackTraceLimit the default max number of lines of a stack trace
*/
describe('context', () => {
...
/* Given a DeepAsync value, a `resolve` function, and optionally a
  ...
  * value *TIn: any DeepAsync value
  * resolve TIn->TOut: a function that accepts the awaited DeepSync(value)
  * reject ? TErr->TOut: a function that accepts the rejected error from the DeepSync(value)

  returns *TOut: a Promise resolving to the output of the `resolve` or `reject` function.
*/
describe('context.await', () => {
